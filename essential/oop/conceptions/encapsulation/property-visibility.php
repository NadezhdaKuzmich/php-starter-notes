...
/*
Інкапсуляція -
• розміщення в одному компоненті даних та методів, які з ними працюють
...
Геттери, сеттери
Трюк, який дозволяє нам отримувати/надавати значення властивостей, які мають області 
видимості protected та private.
*/
